        ...
        <div class="form-container">
          ...
          <div class="form-field">
            ...
            <div class="label-picker">
              ${ft.map(i=>{let a=this._activeMonths.includes(i);return d`<button
                  type="button"
